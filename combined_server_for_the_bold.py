...
parser.add_argument('--game_path', type=str, default='/mnt/c/SAMUEL/ddlc-win/DDLC-1.1.1-pc',
                    help='path to game')
...
#Launch the game
#subprocess.Popen("bash /home/kotomine/DDLC/DDLC-1.1.1-pc/DDLC.sh",shell=True)

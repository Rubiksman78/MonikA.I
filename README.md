...
To install the user version with executables, a tutorial is available [here](https://github.com/Rubiksman78/MonikA.I/wiki/Installation-tutorial-(after-2.0)) from version 2.0.
